...
export function Post<T>({ post }: TableProps<T>) {
    return (
        <div className='bg-gray-700 border px-4 py-6 my-3 border-gray-600 rounded-xl w-full flex flex-col'>
            <div className="flex pb-4 w-full justify-between items-center">
                <div className="userProfile flex">
                    ...
                    <div className="flex-col">
                        <p className='text-gray-400'>{post.user.name}</p>
                        <div className="flex">
                ...
                <button type='button' className='bg-gray-700 text-white text-2xl justify-self-end mr-2'>...</button>
            </div>
